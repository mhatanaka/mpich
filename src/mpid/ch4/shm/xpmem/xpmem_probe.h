 ...
 */
#ifndef XPMEM_PROBE_H_INCLUDED
#define XPMEM_PROBE_H_INCLUDED
                                        ...
                                        int *flag, MPIR_Request ** message, MPI_Status * status)
{
    ...
    mpi_errno = ((&MPIDI_SHM_native_posix_funcs)->mpi_improbe)(source, tag, comm, context_offset, flag, message, status);
                                       ...
                                       int context_offset, int *flag, MPI_Status * status)
{
    ...
    mpi_errno = ((&MPIDI_SHM_native_posix_funcs)->mpi_iprobe)(source, tag, comm, context_offset, flag, status);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_SHM_MPI_IPROBE);
    return mpi_errno;
}

#endif /* XPMEM_PROBE_H_INCLUDED */
